      ...
      <div className="faq-page-container flex flex-col gap-10">
        ...
        <section className="mt-0">
          ...
          <div className="mt-4">
            ...
            <p>Email: <a href="mailto:support@phinance.com" className="text-blue-600">support@phinance.com</a></p>
            <p>Phone: 9654321011</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="mt-4">
            ...
            <p>Simply sign up for an account, and you’ll receive ₹25,000 in virtual funds. From there, you can begin trading stocks in our simulated environment just as you would in a real trading platform.</p>
          </div>
          <div className="mt-4">
          ...
          */}
          <div className="mt-4">
            <h3 className="font-semibold">5. How does the AI-powered prediction feature work?</h3>
          ...
          <div className="mt-4">
            <h3 className="font-semibold">6. What happens if I lose all my virtual funds?</h3>
          ...
          <div className="mt-4">
            <h3 className="font-semibold">7. What is the portfolio management tool?</h3>
            <p>Our portfolio management feature allows you to create a portfolio of stocks and track its performance.</p>
          </div>
          {/*
          <div className="mt-4">
          ...
          */}
          <div className="mt-4">
            <h3 className="font-semibold">8. How does the risk analysis tool work?</h3>
            <p>Our platform provides risk analysis tools like Value at Risk (VaR) to help you evaluate the potential risk of your trades.</p>
          </div>
          {/*
          <div className="mt-4">
          ...
          */}
          <div className="mt-4">
            <h3 className="font-semibold">9. How does the behavioral analytics feature work?</h3>
          ...
          <div className="mt-4">
            <h3 className="font-semibold">10. Is the platform free to use?</h3>
            <p>Yes, our platform is completely free to use, and you get ₹10,000 in virtual funds upon registration to start trading.</p>
          </div>
          <div className="mt-4">
            <h3 className="font-semibold">11. How can I contact support?</h3>
