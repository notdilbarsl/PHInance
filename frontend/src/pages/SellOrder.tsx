...
const SellOrder = () => {
  ...
  const [limitPrice, setLimitPrice] = useState<number>(1752.50);
    ...
    <div className="flex w-full p-5">
      ...
      <div className="w-1/3 p-5 bg-white dark:bg-gray-900 rounded-lg shadow-lg">
        ...
        <div className="flex space-x-2 mb-4">
          ...
          <button className="px-4 py-1 border rounded-md bg-red-400 text-white">BSE</button>
        </div>
        ...
        <div className="flex space-x-2 mb-4">
          ...
          <button
            className={`flex-1 py-2 rounded-md font-semibold ${
              tradeType === "INTRADAY" ? "bg-red-400 text-white" : "bg-gray-200 text-gray-700"
            }`}
        ...
        <div className="flex items-center space-x-2 mb-4">
          ...
          <button
            className={`px-4 py-2 rounded-md font-semibold ${
              orderType === "LIMIT" ? "bg-red-400 text-white" : "bg-gray-200 text-gray-700"
            }`}
          ...
          <button
            className={`px-4 py-2 rounded-md font-semibold ${
              orderType === "MARKET" ? "bg-red-400 text-white" : "bg-gray-200 text-gray-700"
            }`}
      ...
      <div className="mb-4 p-3 border rounded-md">
        ...
        {stopLossEnabled && (
          <div className="mt-3">
            ...
            {/* Market Price */}
            <div className="mt-3">
              <label className="block text-gray-700 font-medium">Limit Price</label>
              <div className="flex items-center space-x-2">
                <button
                  className="p-2 bg-gray-200 rounded-md"
      ...
      <div className="flex justify-between text-gray-700 dark:text-white mb-4">
        <p>Margin Required: <span className="font-semibold">₹5257.5</span></p>
        <p>Available Cash: <span className="font-semibold">₹8370.25</span></p>
      </div>

      {/* Buy Button */}
      <button className="w-full py-3 bg-red-400 text-white font-semibold rounded-md">
        PLACE SELL ORDER
      </button>
      </div>
    </div>
